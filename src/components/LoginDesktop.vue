        ...
        <form>
          ...
          <div class="form form-group">
            ...
            <div class="input-group mt-2">
              <input v-if="!isPassShow" type="password" class="input form-control" v-model="user.password" placeholder="Password">
              ...
              <span class="input input-group-text">
                <button type="button" @click="showHide()" class="showHideBtn">
                  <svg v-if="!isPassShow" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye" viewBox="0 0 16 16">
