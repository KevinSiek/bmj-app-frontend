  ...
  <div class="contain background shadow">
    ...
    <form @submit.prevent="action()" class="row form">
      ...
      <div class="input form-group col-12">
        ...
        <input type="text" class="form-control mt-2" v-model="employee.phone" placeholder="Phone Number" disabled>
      </div>
      <div class="input form-group col-12">
      ...
      <div class="input form-group col-6" v-if="isShowPasswordInputs">
...
const isShowPasswordInputs = ref(false)
