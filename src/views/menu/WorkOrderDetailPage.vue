      ...
      <div class="lower my-2">
        <div class="left">
          ...
          <div class="input form-group col-12">
            ...
            <input type="text" class="form-control mt-2" v-model="workOrder.proformaInvoice.no" placeholder="No">
          </div>
          <div class="input form-group col-12">
            <label for="">Date</label><br>
            <input type="text" class="form-control mt-2" v-model="workOrder.proformaInvoice.date" placeholder="Date">
          </div>
        </div>
        <div class="right">
