<template>
  <div class="contain background shadow">
    ...
    <form class="row form">
      ...
      <div class="lower my-2">
        ...
        <div class="upper my-2">
          <div class="left my-2">
            <div class="title">Select PO Service</div>
            <div class="data">
          ...
          <div class="right my-2">
            <div class="title">Select PO Sparepart <small class="text-muted">(optional)</small></div>
            <div class="data">
  ...
  <div class="button">
    ...
    <div class="right">
      <button type="button" class="btn btn-process" @click="doSaveConfirmation" :disabled="isProcessing">Save</button>
    </div>
  </div>
</template>
...
const doSaveConfirmation = () => {
  modalStore.openConfirmationModal('to save this Work Order?', 'Work Order Saved', doSave)
}
