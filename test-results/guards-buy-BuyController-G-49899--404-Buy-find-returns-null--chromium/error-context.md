...
- Name: guards-buy.spec.js >> BuyController Guards — negative-path & authz >> GUARD-BUY-006: reject with non-existent id → 404 (Buy::find returns null)
- Location: e2e\guards-buy.spec.js:101:3
